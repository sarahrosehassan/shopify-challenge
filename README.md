...
2. Open the command line in "...Python\Python37-32\Scripts" and run the command, where 'requirements.txt' should be a path to the requirements.txt file in the project folder:
```pip install -r requirements.txt```

3. Open the command line in your python directory, then move to the project folder and run the command:                                                                  
```python main.py```
